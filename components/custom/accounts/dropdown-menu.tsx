// @/components/custom/accounts/dropdown-menu.tsx
"use client";
...
interface Props {
  ...
  actions: {
    edit?: (data: Accounts) => void;
    details?: (data: Accounts) => void;
    duplicate?: (data: Accounts) => void;
    delete?: (data: Accounts) => void;
  };
}

export function AccountsDropdownMenu({ row, actions }: Props) {
  const {
    edit,
    details,
    duplicate,
