// @/components/custom/assignments/dropdown-menu.tsx
"use client";
...
interface Props {
  ...
  actions: {
    edit?: (data: Assignments) => void;
    details?: (data: Assignments) => void;
    duplicate?: (data: Assignments) => void;
    delete?: (data: Assignments) => void;
  };
}

export function AssignmentsDropdownMenu({ row, actions }: Props) {
  const {
    edit,
    details,
    duplicate,
