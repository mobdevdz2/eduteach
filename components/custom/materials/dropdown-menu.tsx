// @/components/custom/materials/dropdown-menu.tsx
"use client";
...
interface Props {
  ...
  actions: {
    edit?: (data: Materials) => void;
    details?: (data: Materials) => void;
    duplicate?: (data: Materials) => void;
    delete?: (data: Materials) => void;
  };
}

export function MaterialsDropdownMenu({ row, actions }: Props) {
  const {
    edit,
    details,
    duplicate,
