// @/components/custom/organizations/dropdown-menu.tsx
"use client";
...
interface Props {
  ...
  actions: {
    edit?: (data: Organizations) => void;
    details?: (data: Organizations) => void;
    duplicate?: (data: Organizations) => void;
    delete?: (data: Organizations) => void;
  };
}

export function OrganizationsDropdownMenu({ row, actions }: Props) {
  const {
    edit,
    details,
    duplicate,
